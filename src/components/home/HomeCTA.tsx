      ...
      <div className="container-narrow mx-auto text-center">
        <div className="relative rounded-3xl overflow-hidden border border-gold/20 p-12 md:p-20">
          ...
          <div className="relative z-10">
            <h2 className="font-display text-5xl md:text-6xl font-light text-gray-900 mb-6 leading-tight">
              Ready to Build <br />
              <span className="text-gradient-gold">Something Extraordinary?</span>
            </h2>
            <p className="font-body text-gray-900/50 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
