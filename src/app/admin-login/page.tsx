    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      ...
      >
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <div className="font-display text-gold tracking-wider text-xs uppercase mb-1">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {error && (
            <p className="text-xs text-red-400 text-center bg-red-400/5 border border-red-400/20 rounded-lg px-3 py-2">
              {error}
            </p>
          )}
